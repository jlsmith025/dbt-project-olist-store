...
product_name_translation as (
    ...
    from 
        {{ ref('stg__product_category_name_translation') }}
...
product_joined as (
    ...
    select
        ...
        ifnull(product_name_translation.product_category_name_english,
            'No English Translation') as product_category_name_english,
    ...
    from
        product
        /* 2 product categories do not have a translation in product_name_translation */
        left outer join product_name_translation on product.product_category_name = product_name_translation.base_product_category_name
